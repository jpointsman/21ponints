...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "healthpoints@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "healthpoints API";

        private String description = "healthpoints API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "healthpoints";
